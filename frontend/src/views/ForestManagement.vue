        ...
        <v-expansion-panel value="1">
            ...
            <v-expansion-panel-text>
                ...
                <v-row dense>
                    ...
                    <v-col cols="4">
                      <v-autocomplete
                        v-model="speciesCommonName"
                        :items="sourceSpeciesCommonName"
                        :loading="searchSpeciesCommonNameLoading"
                        v-model:search="searchSpeciesCommonName"
                        hide-selected
                        :item-title="item => item.name"
                        item-text="name"
                        item-value="uuid"
                        label="Espécie - Nome Popular"
                        placeholder="Dígite o nome popular da espécie"
                        no-data-text="Nenhum nome popular encontrado"
                        return-object
                        chips
                        closable-chips
                        clearable
                    ...
                    <v-col cols="4">
                      <v-autocomplete
                        v-model="speciesScientificName"
                        :items="sourceSpeciesScientificName"
                        :loading="searchSpeciesScientificNameLoading"
                        v-model:search="searchSpeciesScientificName"
                        hide-selected
                        :item-title="item => item.name"
                        item-text="name"
                        item-value="uuid"
                        label="Espécie - Nome Científico"
                        placeholder="Dígite o nome científico da espécie"
                        no-data-text="Nenhum nome científico encontrado"
                        return-object
                        chips
                        closable-chips
                        clearable
                ...
                <v-row dense class="bg-grey-lighten-4">
                    <v-col cols="6">
                      <v-autocomplete
                        ...
                        hide-selected
                        :item-title="item => item.name + ' - ' + item.city_state.abbr"
                        item-text="name"
                        item-value="uuid"
                        label="Município Remetente"
                        placeholder="Dígite o nome do município"
                    ...
                    <v-col cols="6">
                        <v-combobox
                          variant="underlined"
                          density="comfortable"
                          v-model="destination_ccsema"
                          label="CC-Sema Destinatário"
                          multiple
                          chips
                          small-chips
                          closable-chips
