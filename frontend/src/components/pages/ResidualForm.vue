    ...
    <v-expansion-panels v-model="expanded" :loading="fetchingData">
        <v-expansion-panel value="1">
            <v-expansion-panel-title color="teal-darken-3" class="text-uppercase">
                Consulta ao dados de Resíduos
            </v-expansion-panel-title>
            <v-expansion-panel-text>
                <v-alert density="compact" variant="outlined" closable color="teal" class="mb-5">
                    Utilize os campos do formulário para
                    consultar os dados de Resíduos. É possível consultar por múltiplos dados em um mesmo campo.
                </v-alert>
                <v-row dense>
                    <v-col cols="6">
                    ...
                    <v-col cols="6">
                        <v-combobox variant="underlined" density="comfortable" v-model="select" :items="residual" label="Resíduos" multiple chips clearable></v-combobox>
                    </v-col>
                </v-row>
...
const residual = ref(["Cavaco", "Pó de serra", "Outros"]);
