        ...
        <v-expansion-panel value="1">
            ...
            <v-expansion-panel-text>
                ...
                <v-row dense>
                    ...
                    <v-col cols="4">
                        <v-combobox variant="underlined" density="comfortable" v-model="select" :items="species_commom_name"
                            label="Espécie - Nome Popular" multiple chips clearable></v-combobox>
                    </v-col>
                    <v-col cols="4">
                        <v-combobox variant="underlined" density="comfortable" v-model="select"
                            :items="species_scientific_name" label="Espécie - Nome Popular" multiple chips
                ...
                <v-row dense class="bg-grey-lighten-4">
                    ...
                    <v-col cols="4">
                        <v-combobox variant="underlined" density="comfortable" v-model="select" :items="destination_city"
                            label="Município Destinatário" multiple chips clearable></v-combobox>
                    </v-col>
                </v-row>
...
const species_commom_name = ref(["Eucalipto", "Itaúba", "Pinheiro", "Cedro"]);
const species_scientific_name = ref(["Eucalyptus", "Mezilaurus", "Pinus", "Cedrus"]);
const source_city = ref(["Matupá", "Juína", "Cuiabá", "Sinop"]);
const destination_city = ref(["Matupá", "Juína", "Cuiabá", "Sinop"]);
